      ...
      <div className="fixed z-50 w-full h-16 max-w-lg -translate-x-1/2 bg-white border border-gray-200 rounded-full bottom-4 left-1/2">
        <div className="grid h-full max-w-lg grid-cols-5 mx-auto">
          <button
            ...
            type="button"
            className="inline-flex flex-col items-center justify-center px-5 rounded-s-full hover:bg-blue-50 group"
          >
          ...
          >
            <WalletIcon className="w-5 h-5 text-gray-500 group-hover:text-blue-600" />
          ...
          <button
            ...
            className="inline-flex flex-col items-center justify-center px-5 hover:bg-blue-50 group"
          >
            <Cog6ToothIcon className="w-5 h-5 text-gray-500 group-hover:text-blue-600" />
          ...
          <button
            ...
            type="button"
            className="inline-flex flex-col items-center justify-center px-5 rounded-e-full hover:bg-blue-50 group"
          >
